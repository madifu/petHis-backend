...
public class CodeGenerator {
    private static final String DATASOURCE = "pet";
    private static final String backendPath = "E:\\MyWork\\madifu\\petHis\\petHis-backend\\";
    private static final String fontendPath = "E:\\MyWork\\madifu\\petHis\\petHis-fontend-admin\\";
        ...
        FastAutoGenerator.create(url, username, password)
                .globalConfig(builder -> {
                    builder.author("") // 设置作者
                            ...
                            .disableOpenDir()
                            .outputDir(backendPath + "src/main/java/"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.example.springboot") // 设置父包名
                            .moduleName(null) // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, backendPath + "src\\main\\resources\\mapper\\")); // 设置mapperXml生成路径
                })
...
//                .templateEngine(new FreemarkerTemplateEngine()) // 使用Freemarker引擎模板，默认的是Velocity引擎模板
    ...
    private static void createVue(String tableName) throws Exception {
        ...
        String format = StrUtil.format(FileUtil.readUtf8String(backendPath + "src/main/resources/templates/vue.template"), map);
        FileUtil.writeString(format, fontendPath + "src/views/" + upperEntityName + ".vue", "UTF-8");
